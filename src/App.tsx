  ...
  return (
    <WeatherFormContextProvider>
      <main className="flex justify-center h-screen w-screen items-center flex-col-reverse gap-4 relative">
        <div
          className="flex flex-col gap-2 p-4 rounded-3xl h-3/4 max-lg:h-auto w-2/4 max-lg:w-2/3 max-md:w-3/4 max-sm:w-4/5  shadow-2xl from-[#023047] from-60%  to-[#106778] 
          bg-gradient-to-tl  relative"
        >
          <TiWeatherPartlySunny
            size={50}
            className="text-yellow-500 absolute max-lg:w-10 max-lg:h-10 cursor-pointer"
            onClick={() => {
